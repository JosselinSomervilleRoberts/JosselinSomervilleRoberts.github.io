new Vue(
  {
    ...
    data: {
      ...
      introitems: [
        ...
        'I am interested in the intersection of machine learning and robotics, and in particular in the application of deep learning to robotics. This includes Computer Vision, Reinforcement Learning, and Natural Language Processing.',
      ...
      papers: [
        ...
        },
        {
          ...
          summary: "This paper introduces a new network architecture for Multi-Task Reinforcement Learning. This architecture consists of a general dense multitask trunk with some low-rank task-specific layers. Unlike other methods, the two dimensions are fused after each layer and we show that the network is able to learn a useful mapping between the shared and task-specific world. We show that this architecture outperforms the State-of-the-art on the MT-10 and MT-50 tasks of Metaworld.",
          ...
          items: [
            {
              ...
              descriptionlist: [
                'In this paper, we trained several VIT-based models to segment cracks and edges.',
                ...
                'The first step was to gather some data as no such data was publicly available. We gathered 100 images from places like Pinnacles National Park, Monument Valley, and the Grand Canyon. In addition, we generated 150 images with DALL-E 2 to increase the diversity',
                ...
                'To have an idea of how subjective this task is we evaluated some humans on the validation dataset who only scored 35% on the DICE metric.',
                'This also showed the fact that classical Computer Vision metrics were not appropriate in our case. In fact, the width of a crack is often very subjective however we are interested in the correct positioning of the crack. Both play a role as important in the DICE metric. This is why we introduced 3 new metrics: LineAcc-position, LineAcc-width, and LineAcc-length, all based on a skeletonization of the crack.',
                'We trained various VIT-based models and introduced a new loss: SKIL (Skeleton Intersection Loss) based on a smooth skeletonization (backpropageable) algorithm introduced by the CL-Dice paper.',
                'Not only our model outperformed the humans, we also showed that our loss was performing better than any other common loss.',
                'In addition, we showed that our loss was useful to other tasks by showing that it ourperforms classic losses on blood vessel segmentation.',
              ],
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'The challenge was to perform 3 tasks with a single BERT backbone: Paraphrase detection (binary classification), Sentiment analysis (multi-class classification), and Semantic textual similarity (regression).',
                ...
                'We even introduced a variant: Gradient compromise to have both gradient surgery methods such as PCGrad and Gradient Vaccine with a scheduling which are normally incompatible.'
              ],
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/2Lqs6AzshpI" frameborder="0"></iframe></div>',
            ...
            },
            {
              ...
              descriptionlist: [
                'After a trip to Vegas, I was fascinated by BlackJack and I decided that I wanted to study the optimal strategy for this game. In addition, I wanted to check how effective counting cards was (with the classic high/low count) and how to optimize the betting strategy based on the true count and the player\'s capital.',
                'The first step was to implement a fast blackjack simulation. While a simple way to do this would have been to simply draw some random cards, I wanted to do something more complex that would properly simulate how blackjack is played in a casino. Most simulations assume that there are 52 times the number of decks and then simply draw cards from this. In reality, in a casino, a game will be played with fewer and fewer cards available until the penetration amount is reached and the cards are shuffled. In addition, other players at the table also draw cards. I wanted to simulate this to be as accurate as possible. As an example I often read some articles doing something similar but with many errors such as applying a Monte-Carlo estimation of the probabilities given a current state. Let\'s say you have a score of 17 and the dealer shows an 8, what should you do? Well, most simulations randomly draw cards without taking into account the fact that we know the hand of the player as well as one card of the dealer. This changes the distribution of the cards in the deck and therefore it was needed to take this into account.',
                'Another thing that I wanted to do was simulate the full rules of blackjack. Most simulations only account for the Hit and Stand actions while all advantage players know that the three other actions: Split, Double, and Surrender are the ones that enable the player to nearly play a zero-sum game without counting (with the optimal strategy the loss is of about 0.50%) and to win money if counting (a few percent).',
                ...
                'In the end, my agent had a positive expected return which was very nice to see. I had beaten the casino (well in simulation). The only thing left is now to learn the strategies and go to the casino!'
              ],
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'The AI was decomposed in several managers that were using the Behaviour Tree to make decisions. The managers were: the General manager, Army manager, and Economy manager.',
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'Don\'t be fooled by the name, Ultimate Tic Tac Toe is a very complex game with no known optimal algorithm as it has an extremely large number of moves possible.',
                'The game consists of a 3x3 tic tac toe grid where each cell is a smaller 3x3 tic tac toe grid (see image below). The goal is to make a line using the large cell. To win a large cell, you have to win its associated small tic tac toe grid.',
                '<img src="images/projects/ultimate_tic_tac_toe/ultimate tic tac toe.png" class="mx-auto d-block img-fluid">',
                'So far this sounds easy, just 9 tic tac toe games in one. Well here comes the twist. In a given small grid, the position where you play determines in which grid your opponent will play his next move.',
                'Here is an example, you play in the middle cell, and in this cell, you place a cross in the top left corner. Therefore, your opponent\'s next move will be constrained to the top left grid. This is what makes the game interesting as sending your opponent to a bad grid can often be better than winning your current grid.',
                ...
                'Then I made various versions of these algorithms confront themselves (and a random agent) (see results below). I also challenged 20 people to beat the best agent and the agent won 17 out of these 20 games.',
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'This consisted of two networks then fused with late fusion. The first network used Node2Vec to embed the co-citation network. The second network used either Word2Vec, TF-IDF or a BERT model to embed the abstracts.',
                'The two networks were then fused using a late fusion method that consisted of concatenating the two embeddings and then using an MLP to predict the H-index.',
                'This model was able to predict the H-index of a researcher with a standard error of around 9. This may seem quite high but it was actually quite good as we had only a few abstracts (up to 5 per researcher) and the H-index is a very noisy metric.',
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'The goal was to not only place automatically speech bubble with a tail attached to the speaker\'s mouth but also in a position that looks good and does not obstruct any important part of the frame.',
                'To do this, I created a placement optimizer that takes into account the speaker\'s mouth position, some obstacles (for example other characters that ideally should not be hidden by the bubble), and some heuristics on the preferred bubble position (usually a well-laced bubble is slightly above the mouth of the speaker but to the side and not directly above its head).',
                'This score is computed for all pixels and then a rectangle of the desired size (based on the subtitles\' length) that maximizes the sum of the score of its pixels is computed. Here is an illustration of the scores:',
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'Various algorithms were used to solve this problem. The first step was to implement A* to find the shortest path for each robot. Then, I implemented a priority queue to find which robots had to arrive first as the goal position of some robots often blocked the path of other robots. Then many optimizations were implemented such as rollbacks, path compression, and more.',
              ...
              pdf_text: 'Many cool optimizations were implemented that could not be explained here. Find the final report (in French sadly) for more details'
            }
          ],
        },
        {
          ...
          items: [
            {
              ...
              description: 'I built a robot arm to pick up and pour beakers into other beakers.',
              image: 'images/projects/robot arm/display.png',
              descriptionlist: [
                'You can see the robot in action here making a small elephant toothpaste:',
                '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/k4rK5P6R8PI" frameborder="0"></iframe></div>',
                'In only 2 weeks, as a team of 4, we designed and built from scratch a 5-axis robot arm to pick, move and rotate beakers in order to make chemical reactions.',
                'As a constrain we had to incorporate in our design: a Stepper, BLDC, DC, and Servo motor as well as a cable, gear, and belt transmission.',
            ...
            },
            {
              id: 1,
              title: 'Mr. Resiskers',
              description: 'A robot cat that comforts the user through a series of multi-modal, two-way interactions',
              ...
              descriptionlist: [
                ...
                '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/vp6l2sRLeEk" frameborder="0"></iframe></div>',
            ...
            },
            {
              ...
              repo: 'LaserGame',
              descriptionlist: [
                'First, I conducted dozens of tests to see if it was possible to send data via infrared signals using a lens at a long distance. After many experiments, I designed an IR receiver that would not only turn off when hit by the gun but would also notify by Wi-Fi the gun that had fired that it had hit its target.',
            ...
            },
            {
              ...
              descriptionlist: [
                'You can see the evolution of Bob v3 in action here:',
                '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/EJegv_kdLi0" frameborder="0"></iframe></div>',
                'And when Bob v3 met his predecessor Bob v1:',
                '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/tPvX0epKcRs" frameborder="0"></iframe></div>',
                ...
                'I first started with different modes that the person controlling Bob could choose. Below, you can first see Bob in his high-speed mode with a body really low and legs moving super fast. Then, the second picture shows Bob in his climbing mode, going super slow with legs lifting up to nearly 12 cm.',
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'Secondly, as it was one of my first experiences with 3D printing, I had made some bad design choices that led to weak pieces because of hard shapes to print.',
                ...
                '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/38Wx9vS37BM" frameborder="0"></iframe></div>',
              ],
            },
            {
              id: 5,
              ...
              descriptionlist: [
                ...
                '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/zXugVYELi-U" frameborder="0"></iframe></div>',
                ...
                'However, I built it on my own and decided to create my own circuit and Arduino program for it (similar to C++ code).',
                ...
                'Once the optimal parameters were found, I designed the robot on Solidworks, 3D printed it, and built it. Here is how it looks:',
          ...
          items: [
            {
              ...
              descriptionlist: [
                'The objective of this project was to create a real-time fast wave simulation to display high-quality images. This included wave generation, foam rendering, buoyancy estimation, and various rendering features (Layered BRDF, reflections, textures, ...) while giving a lot of control to the user: wind speed, seafoam parameters, object weight, ...',
                ...
                '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/nDVD9M3eRyM" frameborder="0"></iframe></div>',
                ...
                'The waves are generated with a superposition of wave trains and some 3D Perlin noise (all on the GPU). The seafoam is computed using a combination of the normal direction, height of the sea, and gradient of the normal.',
                'Objects (like the ship) are also simulated by creating a simplified floating mesh that is used to compute the position of the complex rendered mesh. Each triangle is positioned on top of the water which we can then use to compute the average translation and rotation of the object (as we are simulating solid objects). This gives a very satisfying tilting movement:',
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'Screen Space Reflections is a very fast approximation of reflections. It consists of using the depth buffer to find the closest object to the camera and then using the normal of this object to compute the reflected ray. This ray is then used to find the color of the reflected object. This is a very fast approximation as it does not require computing any ray-object intersection (while I am talking about rays, this is not Ray Tracing but a second Rasterization pass). See below an image without and with SSR:',
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/AQMES8Xu4I0" frameborder="0"></iframe></div>',
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'This remake included a few changes that I liked. The player controlled 2 Pokemons: one main that the player controlled with the keyboard and one secondary that followed the first and only gave bonuses to the main one. The player could switch between the two at any time but also decide to split them to put up two fights at the same time. In that case, the player would control both with a click (which required some pathfinding algorithm to avoid obstacles and a way to reform into the following formation).',
                'A basic AI with pathfinding was implemented for enemies but I did not get time to implement a proper combat system as I was passing the nationwide French exams to enter an engineering school.',
              ]
            },
            {
              id: 21,
              ...
              descriptionlist: [
                'This project was a multiplayer arena game coded from scratch in C++ using OpenGL. It was my first large programming project. I spent a year on this game spending hours per day and it taught me a lot about programming.', ,
                'You can visit the website of the game here: <a href="http://magic-arena.free.nf">http://magic-arena.free.nf</a>',
                '<img src="images/projects/magic arena/image 1.png" class="mx-auto d-block img-fluid">',
                'This project was a personal challenge to learn on my own how to code in C++ during high school. At this time I was still new to programming which led to some bad decisions such as using Qt to build the UI. This was a bad idea as it was not optimized for games and I had to code a lot of things from scratch and spend many many hours optimizing things to compensate for the lack of performance.',
                'However, I learned a lot about programming and C++ and I am still proud of this project.',
                'The game was a multiplayer arena game in which players could choose a class and fight each other. You can play with people connected to the same network (this was a big challenge to implement). Five classes are implemented and in addition, you get to choose a pet from 100 different pets. Your pet follows you and gives you various bonuses but are mostly here for the aesthetics (you unlock them after each win except a few that I kept for myself).',
                'Each character has 2 weapons and 5 spells including an ultimate. The game is played with a keyboard and a mouse. You can fully customize your controls.',
                'Here are a few screenshots of the game:',
                '<img src="images/projects/magic arena/combined_1.jpg" class="mx-auto d-block img-fluid">',
                '<img src="images/projects/magic arena/combined_2.jpg" class="mx-auto d-block img-fluid">',
              ],
              repo: "Magic-Arena",
            },
          ],
          ...
          items: [
            {
              ...
              descriptionlist: [
                ...
                '<img src="images/projects/SemApi/screen.jpg" class="mx-auto d-block img-fluid">',
            ...
            },
            {
              ...
              descriptionlist: [
                ...
                'We ended up creating a structure to represent a story as a graph. Some parts of the graph represented the minimal information while other parts represented additional information that could be specified based on the talkative nature of the NPC, knowledge of the NPC, or even during the conversation. Here is an example of a graph (in French):',
      ...
      jobitems: [
        {
          ...
          description: 'I work on the Madrona Engine, a research game engine that achieves extremely high throughput. I work on the adaptation of RL algorithms to huge batch sizes that are now possible with the engine. Supervised by <a href="https://graphics.stanford.edu/~kayvonf/">Kayvon Fatahalian</a>',
        ...
        },
        {
          ...
          description: 'I worked in the Computer Vision team for autonomous driving. I developed new augmentations to simulate droplets, patches of dirt, and many more obstacles on a camera lens. I then trained a model to detect these.',
        ...
        },
        {
          ...
          title: 'Stanford CRFM',
          subtitle: 'Research Assistant',
          description: 'I am working on the HELM project. The goal of HELM is to provide a unified framework to evaluate foundation models. Supervised by <a href="https://cs.stanford.edu/~pliang/">Percy Liang</a>',
        ...
        },
        {
          ...
          subtitle: 'Research Assistant',
          description: 'This is a video discussion platform for small groups of people designed to facilitate a structured and equitable conversation with better opportunities for participants to speak up. Supervised by <a href="https://web.stanford.edu/~ashishg/">Ashish Goel</a>',
